        ...
        <>
          ...
          <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'tween', duration: 0.3 }} className="fixed right-0 top-0 h-full w-full sm:w-[450px] bg-white z-50 shadow-2xl flex flex-col p-6">
            {!showCheckout ? (
              ...
              <>
                <div className="flex justify-between items-center border-b border-gray-100 pb-4 mb-6">
                  <h2 className="text-xl font-serif text-black font-semibold">Order Summary</h2>
                  <button onClick={() => setShowCheckout(false)} className="p-2 text-gray-400 hover:text-black focus:outline-none"><FiX className="w-5 h-5" /></button>
                </div>
                ...
                <div className="flex-grow overflow-y-auto pr-2 mb-6 space-y-4">
                  <div className="border-b border-gray-100 pb-4">
                    ...
                    {cartItems.map((item) => (
                      <div key={item.id} className="flex justify-between text-sm text-gray-600 py-2 border-b border-gray-50 last:border-b-0">
                        <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-lg font-bold text-black border-t border-gray-200 pt-3 mt-3">
                      <span>Total:</span>
                      <span>₵{totalPrice.toFixed(2)}</span>
                    </div>
                  </div>
                ...
                <div className="border-t border-gray-100 pt-4 space-y-3 mt-auto">
                  ...
                  <button 
                    ...
                    className="w-full bg-black text-white py-3 uppercase text-xs tracking-widest font-bold hover:bg-amber-400 hover:text-slate-950 transition rounded-sm"
                  >
                    Confirm Order
                  </button>
                </div>
